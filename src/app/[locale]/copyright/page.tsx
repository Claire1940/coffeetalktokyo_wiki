...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Coffee Talk Tokyo Wiki',
    description: 'Copyright and intellectual property information for Coffee Talk Tokyo Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Coffee Talk Tokyo Wiki',
      description: 'Copyright and intellectual property information for Coffee Talk Tokyo Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Coffee Talk Tokyo Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Coffee Talk Tokyo Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Coffee Talk Tokyo Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Coffee Talk Tokyo Developers</strong> - Creators of the Coffee Talk Tokyo game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>COFFEE TALK TOKYO</strong> - Trademark of Chorus Worldwide Games and Toge Productions</li>
              <li><strong>Coffee Talk Tokyo</strong> - Trademark of the game developers</li>
              <li><strong>Coffee Talk Tokyo Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Coffee Talk Tokyo Wiki.
            </p>
            ...
            <p>
              ...
              Coffee Talk Tokyo Wiki<br />
              Email: <a href="mailto:dmca@coffeetalktokyo.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@coffeetalktokyo.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Coffee Talk Tokyo Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Coffee Talk Tokyo Wiki (coffeetalktokyo.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@coffeetalktokyo.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@coffeetalktokyo.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@coffeetalktokyo.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@coffeetalktokyo.wiki</a>
            </p>
            <p>
